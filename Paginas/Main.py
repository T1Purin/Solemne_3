...
def main():
    ...
    genre_files = [f'/home/Cinnamoroll/Documentos/Archivos/Python/Github/Solemne_3/Archivos/genres_part{i}.csv' for i in range(1, 2)]  # Suponiendo que hay 11 archivos de géneros

    # Archivos de actores (58 partes)
    actor_files = [f'/home/Cinnamoroll/Documentos/Archivos/Python/Github/Solemne_3/Archivos/actors_part{i}.csv' for i in range(1, 8)]  # Cargar los 58 archivos de actores
    ...
    dp_chunks = pd.read_csv('/home/Cinnamoroll/Documentos/Archivos/Python/Github/Solemne_3/Archivos/posters_part1.csv', sep=',', encoding='utf', engine='python', on_bad_lines='skip', chunksize=25000)
    dp = next(dp_chunks).fillna('')  # Llenar los valores nulos de los pósters con una cadena vacía

    dm_chunks = pd.read_csv('/home/Cinnamoroll/Documentos/Archivos/Python/Github/Solemne_3/Archivos/movies_part1.csv', sep=',', encoding='utf', engine='python', on_bad_lines='skip', chunksize=25000)
